...
\begin{frame}
  \frametitle{\normalsize POTFIT compared to HOOI}
  \vspace{-1cm}
\begin{columns}
...
\begin{block}{}
    \begin{itemize}
    	...
    	\item \footnotesize POTFIT optimizes the SPPs in a slightly different manner: 
...
\section{Example applications}\label{applic}

\begin{frame}[fragile]
  \frametitle{The Heidelberg implementation of MCTDH}
  \justifying{
  The actual implementation is written mainly in\img{fort.png}, with some small\img{c.png}contributions. The program has a modular structure with a very intuitive and consistent input syntax. Some sections of a POTFIT input file:}
